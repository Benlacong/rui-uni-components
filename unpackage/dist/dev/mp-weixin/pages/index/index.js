...
var _menu = _interopRequireDefault(__webpack_require__(/*! ./menu.js */ "F:\\hb\\rattenking-dtpicker\\pages\\index\\menu.js"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  data: function data() {
    return {
      menu: _menu.default };
...
var render = function() {
  ...
  return _c(
    "view",
    {
      ...
      attrs: { url: _vm.url, eventid: "458b8eb5-0" },
      on: {
        tap: function($event) {
    ...
    [
      _c("view", { staticClass: "rui-flex-left" }, [
        _c(
          "text",
          {
      ...
      _c("text", { staticClass: "rui-li-more" })
    ]
  )
}
var staticRenderFns = []
